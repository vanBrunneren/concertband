...
@section('content')
	...
	<div class="container">
		...
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<input type="hidden" name="imagepath" value="{{ $portrait->imagepath }}" />
			<div class="form-group">
				...
				<button type="submit" class="btn btn-danger" formaction="/admin/portrait/image/remove/{{ $portrait->id }}">Bild löschen</button>
			</div>
			<div class="form-group">
